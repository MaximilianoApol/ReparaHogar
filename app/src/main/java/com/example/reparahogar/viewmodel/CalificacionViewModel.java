...
public class CalificacionViewModel extends AndroidViewModel {
    ...
    private final MutableLiveData<String> errorMensaje =
            new MutableLiveData<>();

    private final MutableLiveData<Boolean> calificacionGuardada =
            new MutableLiveData<>();
    ...
    public void guardarCalificacion(String servicioId,
                                    String proveedorUid,
                                    String clienteUid,
                                    int puntuacion) {

        if (!validar(servicioId, proveedorUid,
                clienteUid, puntuacion)) {
            return;
        }
        ...
        calificacionRepository.guardar(
                calificacion,
                new CalificacionRepository.OnResultListener() {
                    ...
                    public void onSuccess() {
                        ...
                        calificacionGuardada.postValue(true);
                    }
    ...
    private boolean validar(String servicioId,
                            String proveedorUid,
                            String clienteUid,
                            int puntuacion) {
    ...
    public LiveData<Boolean> getCalificacionGuardada() {
    ...
    public void limpiarCalificacion() {
        calificacionGuardada.setValue(null);
    }
}