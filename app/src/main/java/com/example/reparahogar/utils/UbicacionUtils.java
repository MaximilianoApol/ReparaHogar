 ...
 * Centraliza el cálculo de distancia para no repetirlo en varios lugares.
 */
public class UbicacionUtils {
    ...
    private UbicacionUtils() {} // No instanciable

    /**
     * Calcula la distancia en kilómetros entre dos coordenadas.
     * Usa la API nativa de Android (Haversine internamente).
     */
